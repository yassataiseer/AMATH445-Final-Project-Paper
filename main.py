...
if __name__ == "__main__":
    ...
    models_and_params: Dict[str, Dict[str, object]] = {
        "Logistic Regression": {
    ...
    all_scores: Dict[str, NDArray] = {}
    summary_data: List[Dict[str, float | str]] = []
    ...
    for name, mp in models_and_params.items():
        ...
        scores: NDArray = random_search.cv_results_['mean_test_score']
    ...
    df_scores: DataFrame =DataFrame.from_dict(all_scores, orient='index').T
